...
public extension ZMPopContainerViewDelegate {
    func popContainerViewWillShow(_ view:ZMPopContainerView) {}
...
@objc open class ZMPopContainerView: UIView, UIGestureRecognizerDelegate {
    ...
    public private(set) var contentInitFrame: CGRect = .zero
    
    public private(set) var contentTargetFrame: CGRect = .zero
    
    public private(set) var animationDuration: TimeInterval = 0
